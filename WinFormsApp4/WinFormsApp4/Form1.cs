...
namespace WinFormsApp4
{
    public partial class Form1 : Form
    {
        ...
        //âñïîìîãàòåëüíûå ìåòîäû äëÿ ğàáîòû ñ ôàéëîì
        #region 
        private void Save()
        {
        ...
        //ğåàëèçàöèÿ êíîïîê ğàáîòû ñ ôàéëàìè
        #region 
        ...
        private void âåğíóòüToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        {
            âåğíóòüToolStripMenuItem_Click(sender, e);
        }
        private void toolStripButton6_Click(object sender, EventArgs e)
        {
            êîïèğîâàòüToolStripMenuItem_Click(sender, e);
        }
